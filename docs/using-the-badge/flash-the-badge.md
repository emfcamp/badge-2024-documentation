...
!!! warning "Remove all hexpansions before flashing"

    Remove all hexpansions from your badge before updating. Hexpansions connected during flashing can cause the process to fail.
...
2.  Hold the **boop** button on the left side of the base board while you connect the badge **USB in** port to your computer. This will load the bootloader.
...
3.  Keep holding the **boop** button until you click on the **Connect** button on the web flasher and select the Tildagon. You can now let go of the **boop** button.
4.  Select the **Install Tildagon** option.

    !!! warning "This will erase all data on the badge"

5.  When prompted to confirm the installation, click _Install_. Installation may take a few minutes.

![Provisioning flow](../images/badge-photos/provision.gif)

When you see the **Installation complete** notification, your badge is flashed. To test your badge, press and hold the **reboop** button (on the left side of the base board) which will perform a soft reboot. When you are done testing, [power off your badge](./end-user-manual.md#power-off) and disconnect it from your computer.
